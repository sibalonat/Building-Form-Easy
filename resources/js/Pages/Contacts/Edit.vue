    ...
    <div class="max-w-3xl overflow-hidden bg-white rounded-md shadow">
      <form @submit.prevent="update">
        <div class="flex flex-wrap p-8 -mb-8 -mr-6">
          ...
          <select-input v-model="form.organization_id" :error="form.errors.organization_id" class="w-full pb-8 pr-6 lg:w-1/2" label="Organization">
            <option :value="null" />
        ...
        <div class="flex items-center px-8 py-4 border-t border-gray-100 bg-gray-50">
          ...
          <loading-button :loading="form.processing" class="ml-auto btn-indigo" type="submit">Update Contact</loading-button>
        </div>
      </form>
    </div>
  </div>
